          ...
          <article className="space-y-5 xl:col-span-2">
            <div className="p-5 space-y-5 rounded-lg bg-white">
              ...
              <div className="sticky bottom-5 flex gap-5 justify-center">
                {post?.next?.slug && (
                  <a href={`/stories/${post.next.slug}`} className="flex grow justify-center items-center px-5 py-2 rounded-lg bg-primary font-semibold text-white xl:hidden hover:bg-secondary ">
                    <span className="grow">Read More Story</span>
